...
<%
	...
	//         new Object[] {"add_payment", lang, ""}, "dm_showseq ASC, dm_createdate DESC");
 	TableRecord dm = app_sm.select(tbldm,"dm_code=? and dm_lang=? and dm_category=?", new Object[]{"add_payment", lang, ""});
...
<head>
    ...
    <script language="JavaScript" type="text/JavaScript">
	    function checkform(F) {
	        ...
	        var safe_pwd_type = /^.*(?=.{8,30})(?=.*\d)(?=.*[A-Z]{1,})(?=.*[a-z]{1,}).*$/;	// 密碼長度需為 8-30 位，其中必須包含1個數字、1個大寫字母、1個小寫字母
	        ...
	        if(F.mp_name.value == "") {
	            ...
	            F.mp_account.focus();
	        } else if(F.mp_password.value.trim() == "" || !safe_pwd_type.test(F.mp_password.value)){
		...
		<!-- InstanceBeginEditable name="main" -->
            <div class="wrap">
                ...
                <div class="right">
                    ...
                    <form name="form_add" method="post" action="<%=page_code %>_update.jsp?action=add" enctype="multipart/form-data" onsubmit="return checkform(this);">
                        <div class="white_bg">
                            <!--表單區-->
                            <div class="form_area">
                                ...
                                <div class="form_list fLType2"><!--一列兩個時class內加fLType2-->
                                    ...
                                    <div class="fLR_info">
                                        <input type="text" name="mp_phone" id="mp_phone">
                                    </div>
                                </div>
                                ...
                                <div class="form_list fLType2"><!--一列兩個時class內加fLType2-->
                                    ...
                                    <div class="fLR_info">
                                        <input type="text" name="mp_unit" id="mp_unit">
                                    </div>
                                </div>
                                ...
                                <div class="form_list fLType2"><!--一列兩個時class內加fLType2-->
                                    ...
                                    <div class="fLR_info">
                                        <input type="text" name="mp_job" id="mp_job">
                                    </div>
                                </div>
                                ...
                                <div class="form_list fLType2"><!--一列兩個時class內加fLType2-->
                                    ...
                                    <div class="fLR_info">
                                    	<input type="hidden" name="rs_type" id="rs_type" value="<%=dm.getString("dm_id") %>"/>
                                ...
                                <div class="form_list fLType2">
                                    ...
                                    <div class="fLR_info">
                                        <input type="text" name="mp_receipt_name" id="mp_receipt_name">
                                    </div>
                                </div>
                                ...
                                <div class="form_list fLType2">
                                    ...
                                    <div class="fLR_info">
                                        <input type="text" name="mp_receipt_address" id="mp_receipt_address" >
                                    </div>
                                </div>
                                ...
                                <div class="form_list fLType2">
                                    ...
                                    <div class="fLR_info">
                                        <input type="text" name="mp_recipient" id="mp_recipient">
                                    </div>
                                ...
                                <div class="form_list fLType2">
                                    ...
                                    <div class="fLR_info">
                                        <input type="text" name="mp_account" id="mp_account">
                                    </div>
                                </div>
                                ...
                                <div class="form_list fLType2"><!--一列兩個時class內加fLType2-->
                                    ...
                                    <div class="fLR_info">
                                        <input type="password" name="mp_password" id="mp_password" placeholder="<%=field_str.get("password_info."+lang) %>">
                                    </div>
                                </div>
                                ...
                                <div class="form_list fLType2"><!--一列兩個時class內加fLType2-->
                                    ...
                                    <div class="fLR_info">
                                        <input type="password" name="mp_pswd" id="mp_pswd">
                                    </div>
                                </div>
                                ...
                                <div class="form_list ">
                                    ...
                                    <div class="fLR_info">
                                        <input type="text" name="mp_address" id="mp_address">
                                    </div>
                                </div>
