...
<%
	...
	try{
		...
		if("apply".equals(action)){
			...
			aa.setValue("aa_no", IDTool.getUID("activity", DateTimeTool.dateString(""), 4));
			...
			out.println("<script> location='activity_apply_sendmail.jsp?aa_id="+aa.getString("aa_id")+"&action=apply&lang="+lang+"'; </script>");		
			return;
		}
