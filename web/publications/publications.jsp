...
<%
	//參數設定
	String page_code 	= "publications", 				  	        // 頁面識別碼
		   banner_code	= "publications",					        // banner識別碼
    ...
    <div class="main">
		...
		<!-- InstanceBeginEditable name="main" -->
            ...
            <div class="left">
                ...
                <%for(TableRecord left_dm:left_dms){ %>
                    <div class="left_list <%=left_dm.getString("dm_id").equals(dm_id)?"active":"" %>"><!--當前模式class加active-->
                        <a href="../publications/publications.jsp?dm_id=<%=left_dm.getString("dm_id") %>">
            ...
            <div class="right">
                ...
                <!--期刊列表-->
                <div class="publication_listArea">
                <%for(TableRecord cp:cps){ 
                    String publication_src = "";

                    if("file".equals(cp.getString("cp_display"))){
                        publication_src = app_fetchpath+"/"+page_code+"/"+lang+"/"+cp.getString("cp_file");
                    } else if ("url".equals(cp.getString("cp_display"))){
                        publication_src = cp.getString("cp_url");
                    }
                %>
                    <div class="publication_list">
                    	<div class="publication_listIn"> 
                            <a href="<%=publication_src %>" target="_blank">
                                <div class="publication_listNo">
                                    <%=cp.getString("cp_title") %>
                                </div>
                                <div class="publication_listImg">
                                    <img src="./images/publication.jpg" alt="">
                                </div>
                                <div class="publication_listDate">
                                    <%=cp.getString("cp_subtitle") %>
                                </div>
                            </a>        
                        </div> 
                    </div>
