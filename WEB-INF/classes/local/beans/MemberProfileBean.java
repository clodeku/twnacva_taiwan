...
public final class MemberProfileBean implements java.io.Serializable {
    ...
    private String mp_receipt_name    = "";
    private String mp_receipt_address = "";
    private String mp_recipient       = "";
    ...
    public void setMp_join(String mp_join) {
        this.mp_join = mp_join;
    }
    ...
    public void setMp_receipt_name(String mp_receipt_name) {
        this.mp_receipt_name = mp_receipt_name;
    }

    public void setMp_receipt_address(String mp_receipt_address) {
        this.mp_receipt_address = mp_receipt_address;
    }

    public void setMp_recipient(String mp_recipient) {
        this.mp_recipient = mp_recipient;
    }
    ...
    public Vector beanContent() {
        ...
        vc.add(mp_address);
        vc.add(mp_email);
        vc.add(mp_receipt_name);
        vc.add(mp_receipt_address);
        vc.add(mp_recipient);
        vc.add(mp_regcode);
        vc.add(mp_command);
        vc.add(mp_mome);
    ...
    public String getMp_receipt_name() {
        return mp_receipt_name;
    }

    public String getMp_receipt_address() {
        return mp_receipt_address;
    }

    public String getMp_recipient() {
        return mp_recipient;
    }
    ...
    private String[] _fnames = new String[] {
        ...
        "mp_mail_status", "at_id", "mp_join", "mp_account", 
        "mp_password", "mp_name", "mp_unit", "mp_job", 
        "mp_gender", "mp_country", "mp_personid", "mp_birthday", 
        "mp_phone", "mp_cellphone", "mp_fax", "mp_county", 
        "mp_city", "mp_zipcode", "mp_address", "mp_email", 
        "mp_receipt_name", "mp_receipt_address", "mp_recipient", "mp_regcode", 
        "mp_command", "mp_mome", "mp_code", "mp_createdate", 
        "mp_createuser", "mp_modifydate", "mp_modifyuser" };
