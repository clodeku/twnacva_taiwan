							...
							<td class="system_bk-2bk"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
								...
								<tr class="web_table-2-1">
									...
									<td align="left" class="tablebg">
										<input name="ai_emitdate" id="ai_emitdate" type="text" value="<%=ai.getString("ai_emitdate") %>" size="15" readonly>
									</td>
									<td align="right" class="tablebg">活動結束日期</td>
									<td align="left" class="tablebg">
										<input name="ai_restdate" id="ai_restdate" type="text" value="<%=ai.getString("ai_restdate") %>" size="15" readonly>
									</td>
								</tr>
