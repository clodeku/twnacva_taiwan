...
<%
	// 基本參數
	String code = "evaluate_text"; 			// 模組識別碼
	String upload_code = "evaluate_text"; 	// 上傳資料夾識別碼
	String show_title = "相關連結維護"; 		// 模組標題
											...
											<td class="system_bk-2bk">
												<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
													...
													<tr class="web_table-2-1">
														...
														<td colspan="3" align="left">
															<input type="text" name="cp_webtitle" id="cp_webtitle" size="137" maxlength="255" value="<%=cp.getString("cp_webtitle") %>"/>
														</td>
													</tr>
