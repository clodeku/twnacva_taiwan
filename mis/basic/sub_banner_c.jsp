							...
							<td class="system_bk-2bk"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
								...
								<tr class="web_table-2-1">
									...
									<td colspan="3" width="85%" align="left">
										<input type="text" name="ap_title" id="ap_title" size="137" maxlength="120" value="<%=ap.getString("ap_title")%>" Disabled/>
									</td>
								</tr>
								...
								<tr class="web_table-2-1">
									...
									<td colspan="3" align="left">
										<input type="text" name="ap_webtitle" id="ap_webtitle" size="137" maxlength="255" value="<%=ap.getString("ap_webtitle") %>"/>
									</td>
								</tr>
								<tr class="web_table-2-1">
