...
<%
	...
	String show_title = "友好連結維護";			// 模組標題

	// 圖片建議尺寸
	String image_info = "(建議尺寸150px * 60px)";
	// 圖片建議尺寸
					...
					<tr>
						...
						<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
							...
							<tr class="web_table-2-1">
								...
								<td colspan="3" align="left">
									<input type="text" name="cp_webtitle" id="cp_webtitle" size="137" maxlength="255" value="<%=SiteSetup.getSetup("web_title"+"."+lang).getString("ss_text") %>"/>
								</td>
							</tr>
							<tr class="web_table-2-1">
