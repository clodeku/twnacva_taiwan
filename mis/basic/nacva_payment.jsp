...
<%
	//基本參數
	String code = "nacva_payment"; 		// 模組識別碼
	String show_title = "NACVA收費項目維護";		// 模組標題
						...
						<table width="100%" border="0" align="center" cellpadding="3"
							...
							<tr class="web_table-2-1">
								...
								<div align="center">
									...
									NTD $ <input name="dm_content" type="text" value="" size="10" maxlength="120"/> 元
								...
								<tr class="web_table-2-1">
									...
									<td align="left">
										<div align="center">
											...
											NTD $ <input name="dm_content" type="text" value="<%=dm.getString("dm_content")%>" size="10" maxlength="120"/> 元
											<input name="dm_category" type="hidden" value="<%=qcategory%>"/>
										</div>
									</td>
									<td align="left">
