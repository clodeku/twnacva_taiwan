...
<%
	...
	String[] titles = new String[] {
		"協會簡介單元頁", "會員資訊單元頁", "教育訓練單元頁", "活動專區單元頁", "評價工具單元頁", "評價法令單元頁", 
		"聯絡我們單元頁", "最新消息單元頁", "出版品單元頁", "研究刊物單元頁", "會員專區單元頁", "友好連結單元頁"
	};
	String[] categorys = new String[] {
		"about", "members_info", "course", "activity", "evaluate", "law", 
		"contact", "news", "publications", "research", "member", "link"
	};
