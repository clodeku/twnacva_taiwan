					...
					<tr>
						...
						<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
							...
							<tr class="web_table-2-1">
								...
								<td colspan="3" width="85%" align="left">
									<input type="text" name="np_title" id="np_title" size="137" maxlength="120" value="<%=np.getString("np_title")%>"/>
								</td>
							</tr>
							...
							<tr class="web_table-2-1">
								...
								<td colspan="3" align="left">
									<textarea name="np_desc" id="np_desc" cols="118" rows="5" class="ezEditor"><%=np.getString("np_desc") %></textarea>
								</td>
							</tr>
							...
							<tr class="web_table-2-1">
								...
								<td colspan="3" align="left">
									<textarea name="np_content" id="np_content" cols="118" rows="8" class="mceEditor"><%=np.getString("np_content") %></textarea>
								</td>
							</tr>
							...
							<tr class="web_table-2-1">
								...
								<td colspan="3" align="left">
									<input type="text" name="np_webtitle" id="np_webtitle" size="137" maxlength="255" value="<%=np.getString("np_webtitle") %>"/>
								</td>
							</tr>
							<tr class="web_table-2-1">
