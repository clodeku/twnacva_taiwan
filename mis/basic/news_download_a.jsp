...
/*----------------------------------------------------------------------------------------------*/
	...
	Vector fds = app_sm.selectAll(tblfd, "fd_code=? and fd_lang=?", new Object[] { "about", lang }, "fd_showseq ASC , fd_createdate DESC");
	...
	<tr>
		...
		<table width="95%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<input type="hidden" name="fk_id" value="<%=np_no %>" />
				<table width="95%" border="0" cellspacing="1" cellpadding="0">
						...
						<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
							<tr>
								<td align="center" colspan="4" class="web_title-1"><%=show_title%>&nbsp;&nbsp;
									...
									<%} %>
									<%if (list_switch) { %>
									<input type="button" value="回到列表" onclick="javascript:location.href='<%=code%>.jsp?np_no=<%=np_no %>'" />&nbsp;
									<%} %>
									<%if (sort_switch) { %>
							...
							<tr class="web_table-2-1">
								...
								<td colspan="3" width="85%" align="left">
									<input type="text" name="fd_title" id="fd_title" size="137" maxlength="120" />
								</td>
							</tr>
							<%-- 
							<tr class="web_table-2-1">
								...
								<td colspan="3" align="left">
									<textarea name="fd_content" id="fd_content" cols="118" rows="8" class="mceEditor"></textarea>
								</td>
							</tr>
							--%>
							<tr class="web_table-2-1">
							...
							<tr class="web_table-2-1">
								...
								<td align="left">
									<input type="text" name="fd_keywords" id="fd_keywords" size="40" maxlength="255" value="<%=SiteSetup.getSetup("seo.keywords"+"."+lang).getString("ss_text") %>"/>
								</td>
								<td align="right">設定網頁版權說明</td>
								<td align="left">
									<input type="text" name="fd_copyright" id="fd_copyright" size="30" value="<%=SiteSetup.getSetup("seo.copyright"+"."+lang).getString("ss_text") %>"/>
								</td>
							</tr>
							<tr class="web_table-2-1">
								<td align="right">
								...
								<td colspan="3" align="left">
									<textarea name="fd_description" id="fd_description" cols="118" rows="3" maxlength="255"><%=SiteSetup.getSetup("seo.description"+"."+lang).getString("ss_text") %></textarea>
								</td>
							</tr>
							<tr class="web_table-2-1">
								<td align="right">設定追蹤碼</td>
								<td colspan="3" align="left">
									<textarea name="fd_seo_track" id="fd_seo_track" cols="118" rows="3"><%=SiteSetup.getSetup("seo.track"+"."+lang).getString("ss_text") %></textarea>
								</td>
							</tr>
							<%} %>
							<%if(deadline_switch){ %>
					...
					<tr align="center">
						...
						<input type="button" value="回上一頁" onClick="location='<%=code%>.jsp?np_no=<%=np_no %>';"> 
					</td>
					</tr>
				</table>
				</form>
