...
<%
	//基本參數
	String code = "members_info"; 				// 模組識別碼
	String show_title = "會員資訊維護";			// 模組標題
...
function checkform(F){	
	...
	if(F.fd_category.value == "") {
        ...
        alert("請輸入標題名稱!!");
        F.fd_title.focus();
    } else if (F.fd_file.value == "" && F.fd_url.value == "") {
		alert("請上傳檔案或輸入連結!!");
		F.fd_file.focus();
    } else {
        return true;
					...
					<tr>
						...
						<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
							...
							<tr class="web_table-2-1">
								...
								<td colspan="3" width="85%" align="left">
									<input type="text" name="fd_url" id="fd_url" size="137" maxlength="120" />
								</td>
							</tr>
							...
							<tr class="web_table-2-1">
								...
								<td colspan="3" align="left">
									<input type="text" name="fd_webtitle" id="fd_webtitle" size="137" maxlength="255" value="<%=SiteSetup.getSetup("web_title"+"."+lang).getString("ss_text") %>"/>
								</td>
							</tr>
							<tr class="web_table-2-1">
