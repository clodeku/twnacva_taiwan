...
<%
	//基本參數
	String code = "tacva_payment"; 		// 模組識別碼
	String show_title = "常年會費項目維護";		// 模組標題
						...
						<table width="100%" border="0" align="center" cellpadding="3"
							...
							<tr class="web_table-2-1">
								...
								<div align="center">
									...
									<input name="dm_content" type="text" value="" size="10" maxlength="120"/> / 年
								...
								<tr class="web_table-2-1">
									...
									<td align="left">
										<div align="center">
											...
											<input name="dm_content" type="text" value="<%=dm.getString("dm_content")%>" size="10" maxlength="120"/> / 年
											<input name="dm_category" type="hidden" value="<%=qcategory%>"/>
										</div>
									</td>
									<td align="left">
