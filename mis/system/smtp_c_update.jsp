...
<%
	// Tiltes.
   	String[] titles = new String[] {
		"郵件伺服器名稱", "郵件伺服器埠號", "認證狀態", "認證帳號", "認證密碼", "管理者名稱", "管理者信箱"
	};
   	
	// Keywords.
   	String[] keywords = new String[] {
   		"smtp.host.name", "smtp.auth.port", "smtp.auth.status", "smtp.auth.account", "smtp.auth.password", "service.email.name", "service.email.address"
   	};
